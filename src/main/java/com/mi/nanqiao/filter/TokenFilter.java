...
public class TokenFilter extends OncePerRequestFilter {
    ...
    private static final Set<String> ALLOW_PATH =
            Collections.unmodifiableSet(Sets.newHashSet("/favicon.ico","/user/captcha", "/user/login", "/user/register", "/user/logout","/file/upload","/doc.html","/swagger-resources","/v3/api-docs"));
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (ALLOW_PATH.contains(uri) || uri.startsWith("/webjars/")) {
            // 放行请求
